    ...
    def setUp(self):
        ...
        self.__contentDefD = {
            ...
            "report-summary-wwpdb-audit-revision": {
                ...
                "type": "rdbms",
                "resource": {"pdbx_audit_revision_history": ("da_internal", "da_internal"), "pdbx_audit_revision_details": ("da_internal", "da_internal")},
                "conditions": {},
            },
            "report-summary-emdb-status": {
                "content": {
                    "em_admin": ["structure_id", "current_status", "deposition_date", "deposition_site", "last_update", "map_release_date", "header_release_date"],
                    "rcsb_status": ["structure_id", "exp_method", "process_site", "rcsb_annotator", "title", "initial_deposition_date"],
                ...
                "conditions": {"rcsb_status": {"exp_method": ("ELECTRON MICROSCOPY", "char", "LIKE")}},
            },
